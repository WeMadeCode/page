...
export const imageRender = (block: BlockFromConfig<typeof imageBlockConfig, any, any>, editor: PageDocEditor<any, any, any>) => {
  ...
  image.alt = block.props.name || block.props.caption || 'PageDoc image'
